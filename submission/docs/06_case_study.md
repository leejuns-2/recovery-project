...
| Event | Actual delayed districts | Event delayed rate | Top-20% delayed rate | Recall@20% | Lift@20% |
|---|---:|---:|---:|---:|---:|
...
이 이벤트의 위험 상위 20%는 delayed 동의 97.3%를 포착했고 Lift@20%는 4.82배였습니다. 이 값은 해당 이벤트에서 관측된 사후 평가 결과이며, 정책 개입 효과나 미래 이벤트 성능을 뜻하지 않습니다.
